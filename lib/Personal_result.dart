...
class PersonalResultWidget extends StatefulWidget {
  const PersonalResultWidget({Key? key}) : super(key: key);

  @override
  _PersonalResultWidgetState createState() => _PersonalResultWidgetState();
}

class _PersonalResultWidgetState extends State<PersonalResultWidget> {
                            ...
                            child: Stack(
                              children: [
                                ...
                                Align(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => PersonalResult2Widget()));
                                    },
                                    child: Text(
                                      '00:00:00 ~ 00:01:00',
                                      style: FlutterFlowTheme.of(context)
