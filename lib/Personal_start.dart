...
class PersonalStartWidget extends StatefulWidget {
  const PersonalStartWidget({Key? key}) : super(key: key);

  @override
  _PersonalStartWidgetState createState() => _PersonalStartWidgetState();
}

class _PersonalStartWidgetState extends State<PersonalStartWidget> {
                            ...
                            child: Stack(
                              children: [
                                ...
                                Align(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      ...
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => PersonalFinWidget()));
                                    },
                                    child: Container(
                                      width: 201,
                                      height: 52,
                                ...
                                Align(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => AnalysisWidget())); //Analysis
                                    },
                                    child: SelectionArea(
                                        child: Text(
                                          'Analysis',
                                ...
                                Align(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => RankingWidget())); //Ranking
                                    },
                                    child: SelectionArea(
                                        child: Text(
                                          'Ranking',
                                ...
                                Align(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => PersonalResultWidget())); //Personal_result
                                    },
                                  ),
                                ),
                                Align(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => GraphDetailWidget())); //Graph
                                    },
                                  ),
                                ),
                                Align(
